...
export const helpContent = `
  <div style="display:flex; justify-content:space-between; align-items:baseline; padding:4px 0; border-bottom:1px dashed #e0e0e0;"><span style="text-align:left; white-space:nowrap; margin-right:20px;">Alt + H</span><span style="text-align:left; white-space:nowrap; color:#CFD3DC;">（回到首页）</span></div>
  <div style="display:flex; justify-content:space-between; align-items:baseline; padding:4px 0; border-bottom:1px dashed #e0e0e0;"><span style="text-align:left; white-space:nowrap; margin-right:20px;">Alt + A</span><span style="text-align:left; white-space:nowrap; color:#CFD3DC;">（查看快捷键）</span></div>
